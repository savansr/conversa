...
var devtools = function devtools(fn, options) {
  return function (set, get, api) {
    ...
    if (!api.devtools) {
      ...
      api.devtools = extension.connect(_extends({}, options));
      api.devtools.prefix = (_options = options) != null && _options.name ? options.name + " > " : '';
...
function subscribeWithSelector(fn) {
  return function (set, get, api) {
  ...
  return function (set, get, api) {
    var _ref2 = options || {},
      ...
      return localStorage;
        ...
        _ref2$partialize = _ref2.partialize,
        partialize = _ref2$partialize === void 0 ? function (state) {
      return state;
    } : _ref2$partialize,
    ...
    if (blacklist || whitelist) {
      console.warn("The " + (blacklist ? 'blacklist' : 'whitelist') + " option is deprecated and will be removed in the next version. Please use the 'partialize' option instead.");
    }
    ...
    var setItem = function setItem() {
      var state = partialize(_extends({}, get()));
